		...
		<div className="col-lg-4 d-none d-md-none d-lg-block align-self-center">
			<div className="d-flex align-items-center">
				<div className="icon pr-2">
				    <img src={ContactImg2} className="img-fluid" alt="SETHU PYRO PARK RACHIKA CRACKERS" title="SETHU PYRO PARK RACHIKA CRACKERS" />
				</div>
            ...
            <div className="mb-4">
                <div className="contact-box-content">
                    <div className="acme heading4"><i className="bi bi-phone icnfnt"></i> Mobile</div>
                                                <div className="pt-3 smallfnt josefin" itemprop="telephone">+91 96267 77758  </div>
                        					                                    </div>
            </div>
        </div>
        <div className="col-lg-4 col-md-4 col-12">
